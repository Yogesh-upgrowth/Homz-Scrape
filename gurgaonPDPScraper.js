...
async function scrapePDP() {
  ...
  try {
    ...
    await page.type("input[type='text']", "Gurgaon", { delay: 100 });
  ...
  // Click on Hot Selling Projects in Gurgaon
  try {
    await page.waitForSelector('a[title*="Hot Selling Projects in Gurgaon"]', {
      timeout: 5000,
    });
    await page.click('a[title*="Hot Selling Projects in Gurgaon"]');
    ...
    fs.writeFileSync(
      "ggnResidentialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to ggnResidentialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Gurgaon Residential Projects");
  }

  // fetching commericial projects in gurgaon
  try {
    ...
    fs.writeFileSync(
      "ggnCommercialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to ggnCommercialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Gurgaon Commercial Projects");
  }
