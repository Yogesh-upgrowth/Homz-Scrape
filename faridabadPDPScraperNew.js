...
async function scrapePDP() {
  ...
  try {
    ...
    await page.type("input[type='text']", "Faridabad", { delay: 100 });

    await page.waitForSelector('[class*="dropdown-menu"]', { timeout: 3000 });
  ...
  // Click on Hot Selling Projects in Faridabad
  try {
    await page.waitForSelector('div[title*="View All Properties for New Projects in Faridabad"]', {
      timeout: 5000,
    });
    await page.click('div[title*="View All Properties for New Projects in Faridabad"]');
    ...
    fs.writeFileSync(
      "faridabadResidentialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to faridabadResidentialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Faridabad Residential Projects");
  }

  // fetching commericial projects in faridabad
  try {
    ...
    fs.writeFileSync(
      "faridabadCommercialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to faridabadCommercialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Faridabad Commercial Projects");
  }
