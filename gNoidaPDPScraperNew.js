...
async function scrapePDP() {
  ...
  try {
    ...
    await page.type("input[type='text']", "Greater Noida", { delay: 100 });
  ...
  // Click on Hot Selling Projects in Greater Noida
  try {
    await page.waitForSelector(
      'a[title*="Hot Selling Projects in Greater Noida"]',
      {
        timeout: 5000,
      },
    );
    await page.click('a[title*="Hot Selling Projects in Greater Noida"]');
    ...
    fs.writeFileSync(
      "gNoidaResidentialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to gNoidaResidentialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Greater Noida Residential Projects");
  }

  // fetching commericial projects in greater noida
  try {
    ...
    fs.writeFileSync(
      "gNoidaCommercialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to gNoidaCommercialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Greater Noida Commercial Projects");
  }
