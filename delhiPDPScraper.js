...
async function scrapePDP() {
  ...
  // Click on Hot Selling Projects in Delhi
  try {
    await page.waitForSelector('a[title*="Hot Selling Projects in Delhi"]', {
      timeout: 5000,
    });
    await page.click('a[title*="Hot Selling Projects in Delhi"]');
    ...
    fs.writeFileSync(
      "delhiResidentialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to delhiResidentialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Delhi Residential Projects");
  }

  // fetching commericial projects in delhi
  try {
    ...
    fs.writeFileSync(
      "delhiCommercialProPDP.json",
      JSON.stringify(results, null, 2),
      "utf-8",
    );
    console.log("Data saved to delhiCommercialProPDP.json");
  } catch (err) {
    console.log("Not able to fetch Delhi Commercial Projects");
  }
